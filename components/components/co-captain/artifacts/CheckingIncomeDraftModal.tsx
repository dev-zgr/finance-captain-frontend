...
import { INCOME_CATEGORIES_WITH_LABELS } from "@/lib/checking-account/constants"
...
export function CheckingIncomeDraftModal(props: Props) {
  return (
    <CheckingDraftModalBase
      {...props}
      title="Review draft income"
      descriptionPlaceholder="What is this income from?"
      categoryItems={INCOME_CATEGORIES_WITH_LABELS}
    />
  )
}
